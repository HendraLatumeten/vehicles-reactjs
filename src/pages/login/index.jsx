        ...
        <div className='formLogin'>
            <Row>
                ...
                <div className='d-none d-sm-block titleName'>
                    ...
                    </div> <Button className='button1'><b>Sign Up</b></Button>
                </div>
                </Col>
                <Col md={ 2 } sm={ 12 }>
                ...
                <Form>
                    ...
                    <div className="d-lg-none d-md-block"> <svg class="animate-bounce w-6 h-6 ..."> </svg>
                        <p className='text1' style={ { color:'white', marginTop:50 } }>Don’t have account?</p> <Button
                            className="button1 animate-bounce" type="submit"> <b> Sign Up</b> </Button>
                    </div>
                </Form>
                </Col>
            </Row>
